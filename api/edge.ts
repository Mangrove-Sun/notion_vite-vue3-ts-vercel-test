    ...
    .send(/* html */ `
      ...
      <html lang="en">
        <head>
          ...
          <meta property="og:url" content="https://notions-vite-vue3-ts-vercel.vercel.app//workspaces/${id}" />
          <meta property="twitter:card" content="summary" />
          <meta property="twitter:site" content="Notion Clone!" />
          <meta property="twitter:title" content="${title}" />
          <meta property="twitter:description" content="${content}" />
          <meta property="twitter:image" content="${poster}" />
          <meta property="twitter:url" content="https://notions-vite-vue3-ts-vercel.vercel.app//workspaces/${id}" />
